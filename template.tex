...
\begin{itemize}
  ...
  \item One or more the following: \textit{dc:coverage}, \underline{\textit{dcterms:spatial}}, \textit{dc:subject}, \textit{dcterms:temporal}, or \textit{dc:type}. Local usage requires \underline{dcterms:spatial} and \underline{dcterms:temporal}. Values from Getty's Thesaurus of Geographical Names (TGN) are used.
...
\begin{itemize}
  ...
  \item \underline{dcterms:temporal}. String-literal values conforming to ISO 8601 are used.
...
\pagebreak[4]
\section{Example}
This example consists of the required elements plus those specific to a particular digital collection.
